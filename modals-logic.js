        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Manejo de enlaces gestionado por script.js
        ...
        function abrirModalEnvejecimientoActivo() {
            ...
            if (modal && data) {
                ...
                if (contenidoElement) {
                    ...
                    contenidoHTML += '<div class="mb-8"><img src="fotos/activo2.webp" alt="Envejecimiento Activo" class="w-full h-96 object-cover rounded-lg shadow-lg"></div>';
